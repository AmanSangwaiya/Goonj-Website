          ...
          <div className="max-w-5xl mx-auto md:flex md:items-start md:gap-8">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-700 text-justify">
                ...
                thriving and beautiful journey. And I really wants to thanks my
                seniors that they always stood by us and helped us out at every
                phase , supported our harsh decisions and understanding us which
                really helped us out for the betterment of the society. Really
                it was such a astonishing journey full of roller coaster rides
                ...
                and coordinators will make it even more big.
              </p>
            </div>
          </div>
        </div>
